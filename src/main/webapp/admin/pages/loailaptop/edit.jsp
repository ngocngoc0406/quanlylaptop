...
<body>
 ...
 <% LoaiLaptop l= (LoaiLaptop) request.getAttribute("list"); %>
		<div class="content">
						...
						<div class="card">
							...
							<div class="card-body card-block">
								<form action="edit" method="post"
									...
									<div class="row">
									<input type="hidden" name="id" value="<%=l.getIdLoai()%>"> 
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-control-label">Tên  loại laptop</label> <input
													type="text" placeholder="Nhập tên laptop"
													class="form-control" name="ten" id="ten" value="<%=l.getTenLoai() %>"> <small></small>
											</div>
										</div>
