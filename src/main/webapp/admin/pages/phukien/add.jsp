					...
					<div class="col-md-12">
						<div class="card">
							...
							<div class="card-body card-block">
								<form action="add" method="post" enctype="multipart/form-data" id="form-action"
									class="form-horizontal">
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-control-label">Tên Phụ Kiện</label> <input
													type="text" placeholder="Nhập tên phụ kiện" class="form-control"
													name="name_phukien" id="tenpk">
													<small></small>
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input
													type="text" placeholder="Nhập số lượng" class="form-control"
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input
													type="text" placeholder="Nhập giá nhập hàng" class="form-control"
													name="gianhap" id="gianhap">
													<small></small>
											</div>
										</div>
										<div class="col-md-6">
