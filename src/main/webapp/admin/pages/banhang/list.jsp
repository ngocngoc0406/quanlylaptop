						...
						<div class="card">
									...
									<div class="col-md-8">
										<div class="form-group">
											<form method="get" action="list" class="d-flex">
												<input type="text" placeholder="Nhập tên người mua hàng"
							...
							<div class="card-body">
								<table id="bootstrap-data-table"
									...
									<tbody>
										<%
										ArrayList<BanHang> list = (ArrayList<BanHang>) request.getAttribute("list");
										for (BanHang l : list) {
										%>
										<tr>
											<td><%=l.getIdBH()%></td>
											<td><%=l.getTenNguoiMua()%></td>
											<td><%=l.getSdtNguoiMua()%></td>
											<td><%=l.getDiaChi()%></td>
											<td><%=l.getGhiChu()%></td>
											<td><%=l.getNgayBan()%></td>
											<td><%=l.getNgayTao()%></td>
											...
											<td><div class="div_action">
													<a class="btn btn-success" href="listdetail?id=<%=l.getIdBH()%>"><span><i
															class="fa fa-edit"></i></span>Chi tiết</a>
												</div></td>
											<td><div class="div_action">

													<a class="btn btn-success" href="edit?id=<%=l.getIdBH()%>"><span><i
															class="fa fa-edit"></i></span> Sửa</a>
													<button class="btn btn-secondary"
														onclick="Delete(<%=l.getIdBH()%>)">
