<%@page import="model.ChitietBanHang"%>
...
<body>
	...
	<div id="right-panel" class="right-panel">
		...
		<%
		ChitietBanHang ctbh = (ChitietBanHang) request.getAttribute("listctbh");
		%>
		<div class="content">
								...
								<form action="editdetail" method="post" id="form-action"
									...
									<div class="row">
										<input type="hidden" class="form-control"
											value="<%=(String) session.getAttribute("idBH")%>"
											name="idHoaDon"> <input type="hidden"
											class="form-control" value="<%=ctbh.getIdCTBH()%>"
											name="idctbh">
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="search-select-box">
													<select data-live-search="true" id="ten" name="idlaptop"
														...
														for (Laptop l : list) {
															if (ctbh.getIdLapTop() == l.getIdLaptop()) {
														%>
												...
												<div class="search-select-box">
													<select data-live-search="true" id="phukien"
														...
														for (PhuKien l : listPK) {
															if(ctbh.getIdPK()==l.getIdPhuKien()){
																%>
										...
										<div class="col-md-6">
											<div class="form-group ">
												<label class="form-control-label">Giá laptop</label> <input
													...
													name="gialaptop" id="gialaptop" onchange="tinhtien()" value="<%=ctbh.getGiaLaptop() %>">
												<small></small>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-control-label">Giá phụ kiện</label> <input
													type="text" placeholder="" class="form-control"
													name="giaphukien" id="giaphukien" onchange="tinhtien()" value="<%=ctbh.getGiaPhuKien()%>">
												<small></small>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-control-label">Số lượng laptop </label> <input
													...
													onchange="tinhtien()" id="soluonglaptop" value="<%=ctbh.getSoLuongLaptop() %>">
												<small></small>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" placeholder="" class="form-control"
													...
													id="soluongphukien" value="<%=ctbh.getSoLuongPhuKien() %>"> <small></small>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
