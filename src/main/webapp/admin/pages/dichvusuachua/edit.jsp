...
<title>Admin - Sửa dịch vu sửa chữa</title>
...
<body>
	...
	<!-- Right Panel -->
<%	DichVuSuaChua dv= (DichVuSuaChua) request.getAttribute("dv") ;%>
					...
					<div class="col-md-12">
						<div class="card">
							...
							<div class="card-body card-block">
								<form action="edit" method="post" class="form-horizontal" id="form_action">
									<div class="row">
										<div class="col-md-6">
										<input type="hidden" name="idDV" value="<%=dv.getIdDV()%>">
											<div class="form-group">
												<label class="form-control-label">Tên Khách hàng</label> <input
													type="text" placeholder="Nhập tên khách hàng" class="form-control"
													name="tenkhachhang" value="<%=dv.getTenKhach()%>" id="tenkhach">
													<small></small>
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-control-label">Số điện thoại khách</label>
												<input
													type="text" placeholder="Nhập số điện thoại" class="form-control"
													name="sodienthoai" value="<%=dv.getSdtKhach()%>" id="sdt">
													<small></small>
											</div>
										</div>
										<div class="col-md-12">
											<div class="form-group">
												...
												<input
													type="text" placeholder="Nhập nội dung sửa" class="form-control"
													name="noidung" value="<%=dv.getNoiDungSuaChua()%>" id="noidung">
													<small></small>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-control-label">Giá sửa chữa</label>
												<input
													type="text" placeholder="Nhập giá sửa" class="form-control"
													name="giasua" value="<%=dv.getGiaTien()%>" id="gia">
													<small></small>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-control-label">Ngày nhận</label>
												<input
													type="date"  class="form-control"
													name="ngaynhan" value="<%=dv.getNgayNhan()%>">
													<small></small>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												...
												<input
													type="date"  class="form-control"
													name="ngaytra" value="<%=dv.getNgayTra()%>">
													<small></small>
											</div>
										</div>
												<div class="col-md-6">
											<div class="form-group">
												...
												<input
													...
													name="ghichu" value="<%=dv.getGhiChu()%>">
													<small></small>
											</div>
										</div>
										<div class="col-md-12">
