...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page
	import="model.LoaiLaptop, model.Laptop, dao.LoaiLaptopDAO, java.util.ArrayList"%>
<!DOCTYPE html>
<html class="no-js" lang="">
<head>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<title>Admin - Sửa laptop</title>
						...
						<div class="card">
							...
							<div class="card-body card-block">
								<form action="edit" method="post" enctype="multipart/form-data"
									...
									<div class="row">
									<input type="hidden" name="idlaptop" value="<%=laptop.getIdLaptop()%>">
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-control-label">Tên laptop</label> <input
													type="text" placeholder="Nhập tên laptop"
													class="form-control" name="ten" id="ten" value="<%=laptop.getTenLaptop()%>"> <small></small>
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-control-label">Giá nhập</label> <input
													...
													class="form-control" name="gianhap" id="gianhap" value="<%=laptop.getGiaNhap()%>"> <small></small>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-control-label">Giá bán</label> <input
													...
													name="giaban" id="giaban" value="<%=laptop.getGiaBan()%>"> <small></small>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-control-label">Số lượng</label> <input
													...
													class="form-control" name="soluong" id="soluong" value="<%=laptop.getSoLuong()%>"> <small></small>
										...
										<div class="col-md-12">
											<div class="form-group">
												<label class="form-control-label">Thông số</label> <input
													...
													class="form-control" name="cauhinh" id="thongso" value="<%=laptop.getThongSo()%>"> <small></small>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
											...
											<div class="form-group">
												<label class="form-control-label">Loại laptop</label> <select
													...
													for (LoaiLaptop l : LoaiLaptopDAO.getAllLoaiLaptop("select *from loailaptop")) {
														if(laptop.getIdLoai()==l.getIdLoai()){
													%>
													
													<option value="<%=l.getIdLoai()%>"  selected="selected"><%=l.getTenLoai()%></option>
													<%
													}else{ %>
