...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="model.HoaDonFullNhapHang"%>
						...
						<div class="card">
								...
								<div class="col-md-12 d-flex">
									<div class="col-md-3">
										<a class="btn btn-primary float-left"
											href="adddetail?id=<%=request.getAttribute("idNH")%>"><span><i
							...
							<div class="card-body">
								<table id="bootstrap-data-table"
									...
									<tbody>
										<%
										ArrayList<HoaDonFullNhapHang> list = (ArrayList<HoaDonFullNhapHang>) request.getAttribute("listNhapHang");
																		for (HoaDonFullNhapHang l : list) {
										%>
										<tr>
											<td><%=l.getIdCTNH()%></td>
											...
											<td><%=l.getTongTien()%></td>
											<td style="display: none"><%=l.getIdNH()%></td>

											<td><div class="div_action">

													<a class="btn btn-success"
														href="editdetail?id=<%=l.getIdCTNH()%>"><span><i
															class="fa fa-edit"></i></span> Sửa</a>
													<button class="btn btn-secondary"
														onclick="Deletedetail(<%=l.getIdCTNH()%>)">
								...
								<div class="float-right"
									style="color: red; margin-right: 100px; font-size: 21px">
