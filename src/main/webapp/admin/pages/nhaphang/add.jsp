									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-control-label">Tên người gừi hàng</label> <input
													type="text" placeholder="Nhập người gửi hàng"
										...
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-control-label">Ngày nhập hàng</label> <input
													type="date" 
													class="form-control" name="ngaynhap" id="ngaynhap"> <small></small>
											</div>
										</div>
