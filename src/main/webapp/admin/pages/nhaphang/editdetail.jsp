<%@page import="model.ChitietNhapHang"%>
...
<title>Admin - Sửa hóa đơn nhập hàng</title>
<meta name="description" content="Admin - Sửa hóa đơn">
...
<body>
	...
	<div id="right-panel" class="right-panel">
						...
						<div class="page-header float-right">
							<div class="page-title">
								<ol class="breadcrumb text-right">
									...
									<li><a href="javascript:void(0)">Hóa đơn nhập bàng</a></li>
		...
		<%
		ChitietNhapHang ctnh = (ChitietNhapHang) request.getAttribute("listctnh");
		%>
		<div class="content">
					...
					<div class="col-md-12">
						<div class="card">
							...
							<div class="card-body card-block">
								<form action="editdetail" method="post" id="form-action"
									class="form-horizontal">
									<div class="row">
										<input type="hidden" class="form-control"
											value="<%=(String) session.getAttribute("idNH")%>"
											name="idHoaDon"> <input type="hidden"
											class="form-control" value="<%=ctnh.getIdCTNH()%>"
											name="idctnh">
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="search-select-box">
													<select data-live-search="true" id="ten" name="idlaptop"
														...
														for (Laptop l : list) {
															if (ctnh.getIdLapTop() == l.getIdLaptop()) {
														%>
														<option value="<%=l.getIdLaptop()%>" selected="selected"><%=l.getTenLaptop()%></option>
														<%
														} else {
														%>
												...
												<div class="search-select-box">
													<select data-live-search="true" id="phukien"
														...
														for (PhuKien l : listPK) {
															if(ctnh.getIdPK()==l.getIdPhuKien()){
																%>
																<option value="<%=l.getIdPhuKien()%>" selected="selected"><%=l.getTenPK()%></option>
																<%
															}else{
																%>
										...
										<div class="col-md-6">
											<div class="form-group ">
												<label class="form-control-label">Giá laptop</label> <input
													...
													name="gialaptop" id="gialaptop" onchange="tinhtien()" value="<%=ctnh.getGiaLaptop() %>">
												<small></small>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-control-label">Giá phụ kiện</label> <input
													type="text" placeholder="" class="form-control"
													name="giaphukien" id="giaphukien" onchange="tinhtien()" value="<%=ctnh.getGiaPhuKien()%>">
												<small></small>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-control-label">Số lượng laptop </label> <input
													...
													onchange="tinhtien()" id="soluonglaptop" value="<%=ctnh.getSoLuongLaptop() %>">
												<small></small>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" placeholder="" class="form-control"
													...
													id="soluongphukien" value="<%=ctnh.getSoLuongPhuKien() %>"> <small></small>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
										...
										<div class="col-md-12">
											...
											<div class="form-actions form-group">
												<button type="submit" class="btn btn-success">Lưu
													lại</button>
												<a class="btn btn-danger" href="listdetail?id=<%=(String) session.getAttribute("idNH")%>">Hủy bỏ</a>
											</div>
										</div>
									</div>
