...
<body>
	...
	<div id="right-panel" class="right-panel">
						...
						<div class="page-header float-right">
							<div class="page-title">
								<ol class="breadcrumb text-right">
									...
									<li><a href="javascript:void(0)">Nhập hàng</a></li>
		...
		<%
		NhapHang nh = (NhapHang) request.getAttribute("nhaphang");
		%>>
		<div class="content">
					...
					<div class="col-md-12">
						<div class="card">
							...
							<div class="card-body card-block">
								<form action="edit" method="post" id="form-action"
									class="form-horizontal">
									<div class="row">
										<input type="hidden" name="idnhaphang"
											value="<%=nh.getIdNhapHang()%>">
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-control-label">Tên người gừi hàng</label>
												<input type="text" placeholder="Nhập người gửi hàng"
													class="form-control" name="ten" id="ten"
													value="<%=nh.getTenNguoiGui()%>"> <small></small>
											</div>
										</div>
										...
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-control-label">Số điện thoại</label> <input
													...
													class="form-control" name="sodienthoai" id="sdt"
													value="<%=nh.getSdt()%>"> <small></small>
											</div>
										</div>
										<div class="col-md-12">
											<div class="form-group">
												<label class="form-control-label">Địa chỉ</label> <input
													...
													name="diachi" id="diachi" value="<%=nh.getDiaChi()%>">
												<small></small>
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-control-label">Ghi chú</label> <input
													type="text" placeholder="Nhập ghi chú" class="form-control"
													name="ghichu" id="ghichu" value="<%=nh.getGhiChu()%>">
												<small></small>
										...
										<div class="col-md-6">
											<div class="form-group">
												<label class="form-control-label">Ngày nhập hàng</label> <input
													type="date" class="form-control" name="ngaynhap"
													id="ngaynhap" value="<%=nh.getNgayNhap()%>"> <small></small>
											</div>
										</div>
